...
var belegungsverpflichtungen = [
	new Regel("In der Qualifikationsphase dürfen keine zusätzlichen Fächer angewählt werden", function() {
		var gewaehlt = [];
	...
	new Regel("In allen Halbjahren bis zum Abitur sind durchgehend die Fächer Deutsch und Mathematik und Sport und eine fortgesetzte Fremdsprache und eine Naturwissenschaften zu belegen.", function() {
		for (var i in noten) {
			var halbjahr = noten[i];
	...
	new Regel("Bis zum Ende des Halbjahres 11/2 bzw. 12/2 muss das Fach Religion belegt werden.", function() {
	...
	new Regel("In mindesten 2 Folgehalbjahren (11/1 bis 11/2 bzw. 12/1 und 12/2) muss Geschichte belegt werden.", function() {
	...
	new Regel("Ein Fach im Aufgabenfeld II (gesellschaftswissenschaftliches Aufgabenfeld) muss durchgängig in allen Halbjahren bis zum Abitur belegt werden.", function() {
	...
	new Regel("Mindestens 9 Kurse müssen pro Halbjahr belegt werden (ÖG).", function() {
		for (var i in noten) {
			var halbjahr = noten[i]
			var count = 0
	...
	new Regel("In der Hauptphase müssen im Aufgabenfeld I mindestens 28, im Aufgabenfeld II mindestens 16 und im Aufgabenfeld III mindestens 22 Halbjahreswochenstunden belegt worden sein. Insgesamt mindestens 124 HalbjahresWoStd.", function() {
		var einsC = 0;
		var zweiC = 0;
		var dreiC = 0;
		for (var i in noten) {
